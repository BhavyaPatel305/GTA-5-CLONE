...
public class Bazooka : MonoBehaviour
{
    ...
    // Max ammo in 1 magazine will be 7
    ...
    // After every 1.3 seconds our shotgun will reload one magazine
    // These times are according to the reloading animation time
    ...
    // If the object being hit is a metal object than we have hitEffect
    ...
    void Shoot(){
        ...
        if(Physics.Raycast(cam.transform.position, cam.transform.forward, out hitInfo, shootingRange)){
            ...
            if(obj != null){
                ...
                // For that we store it in a variable named hitEffectGo
                GameObject hitEffectGo = Instantiate(hitEffect, hitInfo.point, Quaternion.LookRotation(hitInfo.normal));
